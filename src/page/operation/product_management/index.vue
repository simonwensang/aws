  ...
  import Upload from '../../../components/common/upload.vue'
    export default {
      ...
      const validateCheckPwd = (rule, value, callback) => {
        ...
        methods: {
            ...
            remove (index) {
                ...
                let deleteUserServerData = {'id':this.data6[index].id}
                 Api.deleteProduct(deleteUserServerData).then(response => {
        ...
        Api.queryBrand(queryUserData).then((data) => {
         ...
         //查询工厂列表
          let queryfactoryData = {
            ...
            Api.queryUserServer(queryfactoryData).then((data) => {
